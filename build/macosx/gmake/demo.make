...
ifeq ($(config),debug_x32)
  ...
  DEFINES += -D_DEBUG
  INCLUDES += -I../../../deps/fmt -I/usr/local/include -I/usr/local/opt/openssl/include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m32 -g -std=c++11
  ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CFLAGS)
  ALL_RESFLAGS += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  LIBS += ../../../bin/macosx/gmake/x32/Debug/libinfluxdb-cpp-rest.a
  LDDEPS += ../../../bin/macosx/gmake/x32/Debug/libinfluxdb-cpp-rest.a
...
ifeq ($(config),debug_x64)
  ...
  ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CFLAGS)
  ALL_RESFLAGS += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  LIBS += ../../../bin/macosx/gmake/x64/Debug/libinfluxdb-cpp-rest.a
  LDDEPS += ../../../bin/macosx/gmake/x64/Debug/libinfluxdb-cpp-rest.a
...
ifeq ($(config),release_x32)
  ...
  ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CFLAGS)
  ALL_RESFLAGS += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  LIBS += ../../../bin/macosx/gmake/x32/Release/libinfluxdb-cpp-rest.a
  LDDEPS += ../../../bin/macosx/gmake/x32/Release/libinfluxdb-cpp-rest.a
...
ifeq ($(config),release_x64)
  ...
  ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CFLAGS)
  ALL_RESFLAGS += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  LIBS += ../../../bin/macosx/gmake/x64/Release/libinfluxdb-cpp-rest.a
  LDDEPS += ../../../bin/macosx/gmake/x64/Release/libinfluxdb-cpp-rest.a
